...
requiredNamed.add_argument("-k", "--khist", metavar="khist_file", required=True, action="store", help="khist file from kmercountexact.sh")
requiredNamed.add_argument("-p", "--peaks",  metavar="peaks_file", required=True, action="store", help="peaks file from kmercountexact.sh")
